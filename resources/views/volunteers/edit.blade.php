                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        {!! Form::text('nric', $volunteer->nric, ['class' => 'form-control', 'required', 'size' => '9', 'pattern' => '^[STFGstfg][0-9]{7}[a-zA-Z]', 'placeholder' => 'e.g. S1234567Z', 'onBlur' => 'javascript:{this.value = this.value.toUpperCase(); }']) !!}
                                    </div>
                                    <!-- Name Form Input -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 form-group">
                                        ...
                                        <div class="inline-field">
                                            ...
                                            <div class="col-md-4">{!! Form::number('date_year', $volunteer->date_of_birth->year, ['class' => 'form-control date-field', 'required', 'min' => '1900', 'max' => Carbon\Carbon::now()->year, 'placeholder' => 'Year']) !!}</div>
                                        </div>
                                    </div>
                                    <!-- Email Form Input -->
                                    <div class="col-md-4 form-group">
