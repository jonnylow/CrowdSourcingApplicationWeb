                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 form-group">
                                        ...
                                        {!! Form::text('nric', null, ['class' => 'form-control', 'size' => '9', 'pattern' => '[STFGstfg][0-9]{7}[a-zA-Z]', 'placeholder' => 'e.g. S1234567Z']) !!}
                                    </div>
                                    <!-- Name Form Input -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        {!! Form::tel('contact_no', null, ['class' => 'form-control', 'maxlength' => '8', 'pattern' => '[0-9]{8}', 'placeholder' => 'e.g. 98765432']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
