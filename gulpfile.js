...
var paths = {
    ...
    'fileinput': './vendor/kartik-v/bootstrap-fileinput/',
...
elixir(function(mix) {
    mix.less('app.less')
        ...
        .copy(paths.fileinput + 'css/fileinput.min.css', 'public/css/fileinput.min.css')
        ...
        .copy(paths.fileinput + 'js/fileinput.min.js', 'public/js/fileinput.min.js')
