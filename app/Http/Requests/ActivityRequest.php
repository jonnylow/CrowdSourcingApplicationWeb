...
class ActivityRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'start_location_name'   => 'alpha_num_space|unique:centres,name,null,centre_id|required_if:start_location,others',
            'start_postal'          => 'digits:6|required_if:start_location,others',
            'end_location'          => 'required',
            'end_location_name'     => 'alpha_num_space|unique:centres,name,null,centre_id|required_if:end_location,others',
    ...
    public function messages()
    {
        return [
            ...
            'start_location_name.alpha_num_space'       => 'Name for home must contain only letters, numbers, or spaces.',
            'start_location_name.unique'                => 'Home is already in the system.',
