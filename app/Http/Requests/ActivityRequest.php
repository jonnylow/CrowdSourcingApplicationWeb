...
class ActivityRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'start_location_name'   => 'alpha_num_space|unique:centre,name,null,centre_id|required_if:start_location,others',
            'start_postal'          => 'digits:6|required_if:start_location,others',
            'end_location'          => 'required',
            'end_location_name'     => 'alpha_num_space|unique:centre,name,null,centre_id|required_if:end_location,others',
