...
class ActivityRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'start_location_name'   => 'location|unique:centre,name,null,centre_id|required_if:start_location,others',
            'start_postal'          => 'digits:6|required_if:start_location,others',
            'end_location'          => 'required',
            'end_location_name'     => 'location|unique:centre,name,null,centre_id|required_if:end_location,others',
    ...
    public function messages()
    {
        return [
            ...
            'start_location.required'                   => 'Home is required.',
            'start_location_name.location'              => 'Name for home must contain only alphabets, spaces, or numbers.',
            'start_location_name.required_if'           => 'Name for home is required.',
            'start_postal.digits'                       => 'Postal code for home must be 6 digits.',
            'start_postal.required_if'                  => 'Postal code for home is required.',
            'end_location.required'                     => 'Appointment venue is required.',
            'end_location_name.location'                => 'Name for appointment venue must contain only alphabets, spaces, or numbers.',
            ...
            'senior_name.name'                          => 'Senior\'s name must contain only alphabets, spaces, commas, hyphens, or slashes.',
            ...
            'senior_nok_name.name'                      => 'NOK\'s name must contain only alphabets, spaces, commas, hyphens, or slashes.',
